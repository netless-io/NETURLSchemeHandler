#
# Be sure to run `pod lib lint NETURLSchemeHandler.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'NETURLSchemeHandler/Classes/**/*'
  
  # s.resource_bundles = {
  #   'NETURLSchemeHandler' => ['NETURLSchemeHandler/Assets/*.png']
  # }
